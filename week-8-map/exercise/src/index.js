...
domReady(() => {
  ...
  // YOUR CODE HERE
  // it should eventually call myVis
  // make sure you import the geojson first and the ops second (no technical reason)
  // some code i made below asks for it to be that way
});
